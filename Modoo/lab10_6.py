# lab10_4.py
# batch normalization을 사용하는 deep-NN로 MNIST 문제 풀기 & tensorboard에 기록하기
...
def grad(model, images, labels):
    ...
    # 여기 수정(network.variables -> network.trainable_variables)
...
"""Writer"""
checkpoint_dir = 'checkpoints/deep_nn_norm_batch'
logs_dir = 'logs/deep_nn_norm_batch'
model_dir = 'deep_nn_norm_batch'

checkpoint_dir = os.path.join(checkpoint_dir, model_dir)
check_folder(checkpoint_dir)
checkpoint_prefix = os.path.join(checkpoint_dir, model_dir)
logs_dir = os.path.join(logs_dir, model_dir)
check_folder(logs_dir)
