# lab10_4.py
# Xavier로 initialization하는 deep-NN로 MNIST 문제 풀기 & tensorboard에 기록하기
...
"""Writer"""
checkpoint_dir = 'checkpoints/deep_nn_xavier'
logs_dir = 'logs/deep_nn_xavier'
model_dir = 'deep_nn_xavier'
