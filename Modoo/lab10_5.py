# lab10_4.py
# dropout으로 정규화하는 deep-NN로 MNIST 문제 풀기 & tensorboard에 기록하기
...
"""Writer"""
checkpoint_dir = 'checkpoints/deep_nn_dropout'
logs_dir = 'logs/deep_nn_dropout'
model_dir = 'deep_nn_dropout'
